# Generated by Django 4.0.3 on 2022-10-31 05:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plantilla_constancias_pdf', models.FileField(blank=True, null=True, upload_to='constancias/base/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='resp', to='TestApp.author')),
            ],
        ),
        migrations.AddField(
            model_name='evento',
